...
@section('content')
    <div class="bg-white shadow-md rounded-lg">
                    <!-- Title -->
                    <h2 class="text-2xl font-semibold text-white bg-teal-600 p-3 rounded-t-lg">Cancelled / Timed Out Top Up</h2>
                        ...
                        <table class="min-w-full bg-white border rounded-md shadow-md">
                            <thead class="bg-gray-200">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 border text-left">Request Date Time</th>
                                    <th class="px-4 py-2 border text-left">Rejected Date Time</th>
                            ...
                            <tbody>
                                <tr class="border-t">
                                    ...
                                    <td class="px-4 py-2 border">2025-02-22 12:30 PM</td>
                                    <td class="px-4 py-2 border">User123</td>
                                    <td class="px-4 py-2 border">Ten Dollars</td>
                                    <td class="px-4 py-2 border">$10.00</td>
                                    <td class="px-4 py-2 border">$20.00</td>
                                    <td class="px-4 py-2 border">Test only</td>
                                    <td class="px-4 py-2 border">Test only</td>
                                </tr>
                                <tr class="border-t">
