...
@section('content')
    <div class="bg-white shadow-md rounded-lg">
                    <!-- Title -->
                    <h2 class="text-2xl font-semibold text-white bg-teal-600 p-3 rounded-t-lg">Pending Withdrawal</h2>
                        ...
                        <table class="min-w-full bg-white border rounded-md shadow-md">
                            <thead class="bg-gray-200">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 border text-left">Withdrawal Details</th>
                                    <th class="px-4 py-2 border text-left">Payment Details</th>
                                    <th class="px-4 py-2 border text-left">Nett Withdrawal</th>
                            ...
                            <tbody>
                                <tr class="border-t">
                                    ...
                                    <td class="px-4 py-2 border">Withdraw test</td>
                                    <td class="px-4 py-2 border">Payment test</td>
                                    <td class="px-4 py-2 border">$10.00</td>
                                    <td class="px-4 py-2 border">Pending</td>
                                    <td class="px-4 py-2 border">Test tick</td>
                                </tr>
                                <tr class="border-t">
