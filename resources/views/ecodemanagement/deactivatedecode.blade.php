...
@section('content')
    <div class="bg-white shadow-md rounded-lg">
                    <!-- Title -->
                    <h2 class="text-2xl font-semibold text-white bg-teal-600 p-3 rounded-t-lg">Deactivated e-Code</h2>
                        ...
                        <table class="min-w-full bg-white border rounded-md shadow-md">
                            <thead class="bg-gray-200">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 border text-left">Deactivated Date Time </th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="border-t">
                                    ...
                                    <td class="px-4 py-2 border">2025-02-21 4:30 PM</td>
                                </tr>
                                <tr class="border-t">
