...
@section('content')
    <div class="bg-white shadow-md rounded-lg">
                    <!-- Title -->
                    <h2 class="text-2xl font-semibold text-white bg-teal-600 p-3 rounded-t-lg">Streaming Point Report</h2>
                        ...
                        <table class="min-w-full bg-white border rounded-md shadow-md">
                            <thead class="bg-gray-200">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 border text-left">Transaction Remarks</th>
                                    <th class="px-4 py-2 border text-left">Debit</th>
                                    <th class="px-4 py-2 border text-left">Credit</th>
                                    <th class="px-4 py-2 border text-left">Balance</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="border-t">
